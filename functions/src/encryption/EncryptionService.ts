 ...
 */
export async function encryptWithMarker(plaintext: string, key: string): Promise<string> {
 ...
 */
export async function decryptWithMarker(value: string, key: string): Promise<string> {
...
export function isEncryptedValue(value: string): boolean {
  return typeof value === 'string' && (
    value.startsWith(ENCRYPTED_MARKER) || value.startsWith('__encrypted__')
  );
}
