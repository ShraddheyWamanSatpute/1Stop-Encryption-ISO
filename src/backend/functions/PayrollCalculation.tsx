    ...
    if (sensitiveDataService.isInitialized()) {
      try {
        ...
        if (import.meta.env.PROD) {
          throw new Error('Encryption required in production. Failed to encrypt payroll data.')
        }
      ...
      if (import.meta.env.PROD) {
        throw new Error('Encryption service not initialized. Cannot store payroll data in production.')
      }
