...
export interface Product {
  ...
  ingredients?: Array<{ type: string; itemId: string; measure: string; quantity: number }>
  ...
  recipe?: {
    items: Array<{ type: string; itemId: string; measure: string; quantity: number }>
    instructions?: string
    prepTime?: number
    cookTime?: number
    servings?: number
...
export interface StockData {
  ...
  suppliers: Supplier[]
  measures: Measure[]
  salesDivisions: Array<Record<string, unknown>>
...
export interface Card {
  ...
  zIndex?: number
  text?: string
  data?: unknown  // For feature cards
...
export interface StockState {
  ...
  categories: Array<Record<string, unknown>>
  subcategories: Array<Record<string, unknown>>
  subCategories: Array<Record<string, unknown>>  // Alias for backward compatibility
  courses: Array<Record<string, unknown>>
  purchases: Purchase[]
  stockCounts: StockCount[]
  stockItems: StockItem[]
  purchaseOrders: PurchaseOrder[]
  parLevels: Array<Record<string, unknown>>
  latestCounts: Record<string, unknown>
...
export type StockAction =
  ...
  | { type: "SET_SALES_DIVISIONS"; payload: Array<Record<string, unknown>> }
  | { type: "SET_CATEGORIES"; payload: Array<Record<string, unknown>> }
  | { type: "SET_SUBCATEGORIES"; payload: Array<Record<string, unknown>> }
  | { type: "SET_SUB_CATEGORIES"; payload: Array<Record<string, unknown>> }  // Alias for backward compatibility
  | { type: "SET_COURSES"; payload: Array<Record<string, unknown>> }
  ...
  | { type: "SET_LATEST_COUNTS"; payload: Record<string, unknown> }
  | { type: "SET_PURCHASE_HISTORY"; payload: Array<Record<string, unknown>> }
  | { type: "SET_SALES_HISTORY"; payload: Array<Record<string, unknown>> }
...
export interface StockContextType {
  ...
  fetchLatestCountsForProducts: () => Promise<Record<string, unknown>>
  // Par Level operations
  saveParLevelProfile: (profile: ParLevelProfileFromDB) => Promise<void>
  fetchParProfiles: () => Promise<ParLevelProfileFromDB[]>
  deleteParProfile: (profileId: string) => Promise<void>
  // Measure operations
  fetchMeasureData: (measureId: string) => Promise<Measure | null>
  // History operations
  fetchSalesHistory: () => Promise<Array<Record<string, unknown>>>
  fetchPurchasesHistory: () => Promise<Array<Record<string, unknown>>>
  fetchCurrentStock: () => Promise<Array<Record<string, unknown>>>
  // Preset operations
  fetchPresetsFromDB: () => Promise<Array<Record<string, unknown>>>
  savePresetToDB: (presetData: Record<string, unknown>) => Promise<void>
  // Course operations
  fetchCourses: () => Promise<Array<Record<string, unknown>>>
  saveCourse: (course: Record<string, unknown>) => Promise<void>
  updateCourse: (courseId: string, course: Record<string, unknown>) => Promise<void>
  ...
  // Location operations
  fetchLocations: () => Promise<Array<Record<string, unknown>>>
  ...
  updateMeasure: (measureId: string, measure: Measure) => Promise<void>
  deleteMeasure: (measureId: string) => Promise<void>
  // Utility functions
  getGoogleMapsApiKey: () => string
  parseAddressComponents: (components: Array<Record<string, unknown>>) => Record<string, unknown>
  // Till screen functions
  fetchTillScreen: (screenId: string) => Promise<TillScreen | null>
  saveTillScreenWithId: (screenId: string, screenData: TillScreen) => Promise<void>
  fetchStockHistory: () => Promise<Array<Record<string, unknown>>>
  // Helper functions
  ...
  // New CRUD functions
  createCategory?: (categoryData: Record<string, unknown>) => Promise<string | undefined>
  updateCategory?: (categoryId: string, categoryData: Record<string, unknown>) => Promise<void>
  deleteCategory?: (categoryId: string) => Promise<void>
  createStockLocation?: (locationData: Record<string, unknown>) => Promise<string | undefined>
  updateStockLocation?: (locationId: string, locationData: Record<string, unknown>) => Promise<void>
  deleteStockLocation?: (locationId: string) => Promise<void>
  createParLevel?: (parLevelData: Record<string, unknown>) => Promise<string | undefined>
  updateParLevel?: (parLevelId: string, parLevelData: Record<string, unknown>) => Promise<void>
  deleteParLevel?: (parLevelId: string) => Promise<void>
  // Product CRUD functions
  createProduct?: (productData: Partial<Product>) => Promise<string | undefined>
