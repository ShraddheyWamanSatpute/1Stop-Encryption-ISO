...
export interface CompanyContract {
  ...
  startDate: number
  endDate?: number
  terms: Record<string, unknown> // Variable values filled in
  pdfUrl?: string
  createdAt: number
  updatedAt?: number
  createdBy: string
...
export const DEFAULT_PERMISSIONS: CompanyPermissions = {
  ...
  departments: {
    ...
    /** Support role: limited scope for help-desk users. Read-only on company/site info. No HR payroll, finance, or HMRC. */
    support: {
      modules: {
        stock: { dashboard: { view: false, edit: false, delete: false }, items: { view: false, edit: false, delete: false }, categories: { view: false, edit: false, delete: false }, suppliers: { view: false, edit: false, delete: false }, orders: { view: false, edit: false, delete: false }, counts: { view: false, edit: false, delete: false }, reports: { view: false, edit: false, delete: false } },
        pos: { dashboard: { view: false, edit: false, delete: false }, orders: { view: false, edit: false, delete: false }, menu: { view: false, edit: false, delete: false }, devices: { view: false, edit: false, delete: false }, payments: { view: false, edit: false, delete: false }, discounts: { view: false, edit: false, delete: false }, categories: { view: false, edit: false, delete: false }, locations: { view: false, edit: false, delete: false }, settings: { view: false, edit: false, delete: false } },
        hr: { dashboard: { view: false, edit: false, delete: false }, employees: { view: false, edit: false, delete: false }, payroll: { view: false, edit: false, delete: false }, timeoff: { view: false, edit: false, delete: false }, performance: { view: false, edit: false, delete: false }, recruitment: { view: false, edit: false, delete: false }, training: { view: false, edit: false, delete: false }, expenses: { view: false, edit: false, delete: false }, incentives: { view: false, edit: false, delete: false }, risk: { view: false, edit: false, delete: false }, analytics: { view: false, edit: false, delete: false } },
        bookings: { dashboard: { view: false, edit: false, delete: false }, calendar: { view: false, edit: false, delete: false }, list: { view: false, edit: false, delete: false }, reports: { view: false, edit: false, delete: false }, settings: { view: false, edit: false, delete: false }, tables: { view: false, edit: false, delete: false } },
        finance: { dashboard: { view: false, edit: false, delete: false }, accounting: { view: false, edit: false, delete: false }, banking: { view: false, edit: false, delete: false }, expenses: { view: false, edit: false, delete: false }, reports: { view: false, edit: false, delete: false }, budgeting: { view: false, edit: false, delete: false } },
        messenger: { chat: { view: false, edit: false, delete: false }, contacts: { view: false, edit: false, delete: false }, groups: { view: false, edit: false, delete: false } },
        company: { setup: { view: true, edit: false, delete: false }, permissions: { view: false, edit: false, delete: false }, checklist: { view: true, edit: false, delete: false } },
        tools: { excel: { view: false, edit: false, delete: false }, pdf: { view: false, edit: false, delete: false }, floorfriend: { view: false, edit: false, delete: false } },
      },
    },
  },
  defaultRole: "staff",
