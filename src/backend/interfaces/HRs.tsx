...
export interface ScheduleManagerProps {
  ...
  bookingsData?: unknown[] // Bookings data from BookingsContext
  businessHours?: Record<string, unknown> // Business hours from booking settings
}
...
export interface HRActionParams<T = unknown> {
  companyId: string
  siteId: string
