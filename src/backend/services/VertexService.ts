...
export async function analyzeHRData(hrData: Record<string, unknown>) {
...
export async function analyzeStockData(stockData: Record<string, unknown>) {
...
export async function analyzeBookingsData(bookingsData: Record<string, unknown>) {
...
export async function analyzeFinanceData(financeData: Record<string, unknown>) {
...
export async function analyzeLocationData(locationData: Record<string, unknown>) {
...
export async function analyzePOSData(posData: Record<string, unknown>) {
...
export async function analyzeCompanyData(companyData: Record<string, unknown>) {
...
export async function analyzeChatPrompt(userMessage: string, contextData?: Record<string, unknown>): Promise<string> {
...
export async function generateBusinessReport(request: string, context?: Record<string, unknown>): Promise<string> {
