...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "../../../yourstop/frontend/src/components/ui/card";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "../../../yourstop/frontend/src/components/ui/tabs";
...
import { Alert, AlertDescription } from "../../../yourstop/frontend/src/components/ui/alert";
...
} from "../../../yourstop/frontend/src/lib/auth-validation";

export default function AuthPage() {
  const navigate = useNavigate();
  const [searchParams] = useSearchParams();
  const { signIn, signUp, resetPassword, signInWithGoogle, signInWithFacebook, loading } = useCustomerAuth();
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        const redirectTo = searchParams.get('redirect') || '/YourStop';
        navigate(redirectTo);
      } else {
