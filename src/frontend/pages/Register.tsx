...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!consentChecked) {
      setError("You must agree to the Privacy Policy and consent to data processing to create an account")
      return
    }
      ...
      >
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary" align="center" sx={{ mb: 2 }}>
            ...
            <Link component={RouterLink} to="/privacy-policy" target="_blank" rel="noopener noreferrer">
              Privacy Policy
            </Link>
            {" "}and consent to processing your data in accordance with UK GDPR.
          </Typography>
