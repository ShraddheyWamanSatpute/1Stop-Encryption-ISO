...
const StockItemForm: React.FC = () => {
  ...
  const filteredCategories = categories.filter((cat: any) =>
    product.salesDivisionId ? cat.parentSalesDivisionId === product.salesDivisionId : true,
  )
      ...
      >
        <Box>
          ...
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="text.primary">{id ? "Edit Product" : "Add New Product"}</Typography>
          </Breadcrumbs>
        </Box>
        <Button
          variant="outlined"
                ...
                <Grid container spacing={2} sx={{ mt: 1 }}>
                  <Grid item xs={12} md={4}>
                    <Autocomplete
                      ...
                      onChange={(_, newValue: { id?: string } | null) => {
                        setProduct({
                          ...product,
