...
// Import auth service to initialize RSA keys on startup
// This ensures keys are loaded and validated when server starts
...
// Rate limiting
// Global API limiter – protects all /api/* endpoints
...
const authLimiter = rateLimit({
  windowMs: 15 * 60 * 1000,
  max: 20, // tighter threshold for login/register/reset flows
